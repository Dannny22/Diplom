...
public class Controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!mainCamera.GetComponent<CameraCharecter>().stickCamera) // Вместо CameraMovement, вам нужно вставить название класса которое вы дали 3rd Person Camera Controller.
        {
